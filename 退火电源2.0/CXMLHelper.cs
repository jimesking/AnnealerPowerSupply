...
namespace 退火电源2._0
{
    class CXMLHelper
    {
        ...
        public static string FilePath = @"ini.xml";
        /// <summary>
        /// 更新节点
        /// </summary>
        /// <param name="path"></param>
        /// <param name="innerText"></param>
        public static void MyUpdataNode(string path,string innerText)
        {
        ...
        //更新属性
        public static void MyUpdataAttribute(string nodePath,string attr,string value)
        {
            XmlDocument xmldoc = new XmlDocument();
            xmldoc.Load(FilePath);
        ...
        public static int MyGetNodeChildCount(string parentNodePath)
        {
            XmlDocument xmldoc = new XmlDocument();
            xmldoc.Load(FilePath);
            XmlNodeList nodeList = xmldoc.SelectSingleNode(parentNodePath).ChildNodes;
            return nodeList.Count;
        }
        public static void MyInertNode(string parentPath,string nodeName,string innerText)
        {
            XmlDocument xmldoc = new XmlDocument();
            xmldoc.Load(FilePath);
